...
@Categories.IncludeCategory({TestCategories.RegistrationAddTest.class,
        TestCategories.RegistrationGetTest.class,
        TestCategories.RegistrationDeleteTest.class})
public class AddGetAndDeleteSuite {
}
